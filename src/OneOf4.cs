...
namespace Grondo
{
    ...
    public readonly struct OneOf<T1, T2, T3, T4> : IEquatable<OneOf<T1, T2, T3, T4>>
    {
        ...
        private OneOf(T1 v) { _value1 = v; _value2 = default; _value3 = default; _value4 = default; Index = 0; }

        private OneOf(T2 v) { _value1 = default; _value2 = v; _value3 = default; _value4 = default; Index = 1; }

        private OneOf(T3 v) { _value1 = default; _value2 = default; _value3 = v; _value4 = default; Index = 2; }

        private OneOf(T4 v) { _value1 = default; _value2 = default; _value3 = default; _value4 = v; Index = 3; }
        ...
        /// <summary>Gets a value indicating whether the instance holds a <typeparamref name="T4"/>.</summary>
        ...
        /// <summary>Gets the <typeparamref name="T4"/> value.</summary>
        public T4 AsT3 => IsT3 ? _value4! : throw new InvalidOperationException($"Cannot access AsT3: OneOf holds T{Index}.");

        /// <summary>Creates a OneOf holding a <typeparamref name="T1"/>.</summary>
        public static OneOf<T1, T2, T3, T4> FromT0(T1 value)
        {
        ...
        public static OneOf<T1, T2, T3, T4> FromT1(T2 value)
        {
            ArgumentNullException.ThrowIfNull(value);
            return new OneOf<T1, T2, T3, T4>(value);
        }
        ...
        public static OneOf<T1, T2, T3, T4> FromT2(T3 value)
        {
            ArgumentNullException.ThrowIfNull(value);
            return new OneOf<T1, T2, T3, T4>(value);
        }

        /// <summary>Creates a OneOf holding a <typeparamref name="T4"/>.</summary>
        public static OneOf<T1, T2, T3, T4> FromT3(T4 value)
        {
            ArgumentNullException.ThrowIfNull(value);
            return new OneOf<T1, T2, T3, T4>(value);
        }
        ...
        public static implicit operator OneOf<T1, T2, T3, T4>(T1 value) => FromT0(value);

        /// <summary>Implicitly wraps a <typeparamref name="T2"/> value.</summary>
        public static implicit operator OneOf<T1, T2, T3, T4>(T2 value) => FromT1(value);

        /// <summary>Implicitly wraps a <typeparamref name="T3"/> value.</summary>
        public static implicit operator OneOf<T1, T2, T3, T4>(T3 value) => FromT2(value);

        /// <summary>Implicitly wraps a <typeparamref name="T4"/> value.</summary>
        public static implicit operator OneOf<T1, T2, T3, T4>(T4 value) => FromT3(value);

        /// <summary>Pattern matches on the current slot and returns a value.</summary>
        public TResult Match<TResult>(Func<T1, TResult> f0, Func<T2, TResult> f1, Func<T3, TResult> f2, Func<T4, TResult> f3)
        {
        ...
        public void Switch(Action<T1> a0, Action<T2> a1, Action<T3> a2, Action<T4> a3)
        {
            ...
            switch (Index)
            {
                ...
                case 3: a3(_value4!); break;
                default: throw new InvalidOperationException("OneOf in invalid state.");
            }
        }

        /// <summary>Indicates whether the current instance is equal to another instance of the same type.</summary>
        public bool Equals(OneOf<T1, T2, T3, T4> other) => Index == other.Index && Index switch
        {
        ...
        public override int GetHashCode() => Index switch
        {
            ...
            3 => HashCode.Combine(Index, _value4),
            _ => 0
        };

        /// <summary>Determines whether two <see cref="OneOf{T1, T2, T3, T4}"/> instances are equal.</summary>
        public static bool operator ==(OneOf<T1, T2, T3, T4> left, OneOf<T1, T2, T3, T4> right) => left.Equals(right);

        /// <summary>Determines whether two <see cref="OneOf{T1, T2, T3, T4}"/> instances are not equal.</summary>
        public static bool operator !=(OneOf<T1, T2, T3, T4> left, OneOf<T1, T2, T3, T4> right) => !left.Equals(right);
